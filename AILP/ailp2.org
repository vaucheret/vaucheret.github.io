#+TITLE:  [[size:65%][Interpretación Abstracta de Programas Logicos]]
#+AUTHOR: 
#+EMAIL: 
...
* [[size:70%][Lenguaje de aserciones]]
 #+REVEAL_HTML: <div style="font-size: 80%;">     
 - ejemplo de ~pred/1~ 
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog
...
** [[size:100%][Lenguaje de aserciones]]
 #+REVEAL_HTML: <div style="font-size: 80%;">     
  - ejemplo de ~comp/1~
     #+REVEAL_HTML: <div style="font-size: 130%;">
     #+BEGIN_SRC prolog
  ...
  - ~test~ es similar a ~success~ pero especifica un caso de test como
    parte de la especificación del predicado
     ...
     #+REVEAL_HTML: </div>
     #+REVEAL_HTML: </div>
* [[size:70%][Lenguaje de aserciones (cont)]]
 #+REVEAL_HTML: <div style="font-size: 80%;">     
